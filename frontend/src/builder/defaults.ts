...
export const BLOCK_DEFINITIONS: BlockDefinition[] = [
  ...
  { type: 'footer', label: 'Footer', icon: '▁', isContainer: true, tab: 'html', category: 'layout', defaultProps: { className: 'px-6 py-4 text-sm text-slate-500' } },
  { type: 'main', label: 'Main', icon: '◻', isContainer: true, tab: 'html', category: 'layout', defaultProps: { className: 'p-6' } },
  { type: 'aside', label: 'Aside', icon: '◧', isContainer: true, tab: 'html', category: 'layout', defaultProps: { className: 'p-4 bg-slate-50' } },
  ...
  { type: 'p', label: 'Párrafo', icon: 'P', isContainer: false, tab: 'html', category: 'texto', defaultProps: { text: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.', className: 'text-slate-600 leading-relaxed' } },
  { type: 'span', label: 'Span', icon: 'S', isContainer: false, tab: 'html', category: 'texto', defaultProps: { text: 'Texto inline', className: '' } },
  { type: 'a', label: 'Enlace', icon: '🔗', isContainer: false, tab: 'html', category: 'texto', defaultProps: { text: 'Enlace', href: '#', className: 'text-blue-600 hover:underline' } },
  ...
  { type: 'code', label: 'Code', icon: '<>', isContainer: false, tab: 'html', category: 'texto', defaultProps: { text: 'const x = 1;', className: 'bg-slate-100 px-1.5 py-0.5 rounded text-sm font-mono text-pink-600' } },
  { type: 'pre', label: 'Pre', icon: '{}', isContainer: false, tab: 'html', category: 'texto', defaultProps: { text: 'function hello() {\n  return "world";\n}', className: 'bg-slate-900 text-slate-100 p-4 rounded-lg text-sm font-mono overflow-x-auto' } },
  { type: 'blockquote', label: 'Cita', icon: '"', isContainer: false, tab: 'html', category: 'texto', defaultProps: { text: 'La simplicidad es la máxima sofisticación.', className: 'border-l-4 border-slate-300 pl-4 italic text-slate-600' } },
  { type: 'hr', label: 'Separador', icon: '—', isContainer: false, tab: 'html', category: 'texto', defaultProps: { className: 'border-t border-slate-200 my-4' } },

  // ── Formulario HTML ──
  { type: 'form', label: 'Form', icon: '📋', isContainer: true, tab: 'html', category: 'formulario', defaultProps: { className: 'space-y-4' } },
  { type: 'input', label: 'Input', icon: '▭', isContainer: false, tab: 'html', category: 'formulario', defaultProps: { placeholder: 'Escribe aquí…', inputType: 'text', label: 'Campo', className: 'w-full border border-slate-300 rounded-md px-3 py-2 text-sm' } },
  { type: 'textarea', label: 'Textarea', icon: '▥', isContainer: false, tab: 'html', category: 'formulario', defaultProps: { placeholder: 'Escribe aquí…', label: 'Descripción', rows: '4', className: 'w-full border border-slate-300 rounded-md px-3 py-2 text-sm' } },
  { type: 'select', label: 'Select', icon: '▾', isContainer: false, tab: 'html', category: 'formulario', defaultProps: { label: 'Selecciona', options: 'Opción 1,Opción 2,Opción 3', className: 'w-full border border-slate-300 rounded-md px-3 py-2 text-sm' } },
  { type: 'label', label: 'Label', icon: 'L', isContainer: false, tab: 'html', category: 'formulario', defaultProps: { text: 'Etiqueta', className: 'block text-sm font-medium text-slate-700' } },
  { type: 'button', label: 'Button', icon: '▸', isContainer: false, tab: 'html', category: 'formulario', defaultProps: { text: 'Botón', className: 'bg-blue-600 text-white px-4 py-2 rounded-md' } },
  { type: 'fieldset', label: 'Fieldset', icon: '▢', isContainer: true, tab: 'html', category: 'formulario', defaultProps: { legend: 'Grupo de campos', className: 'border border-slate-300 rounded-lg p-4' } },
  ...
  { type: 'ul', label: 'Lista (ul)', icon: '•', isContainer: false, tab: 'html', category: 'tabla', defaultProps: { items: 'Elemento 1,Elemento 2,Elemento 3', className: 'list-disc list-inside space-y-1 text-slate-600' } },
  { type: 'ol', label: 'Lista (ol)', icon: '1.', isContainer: false, tab: 'html', category: 'tabla', defaultProps: { items: 'Primero,Segundo,Tercero', className: 'list-decimal list-inside space-y-1 text-slate-600' } },
  ...
  // ── Media ──
  { type: 'img', label: 'Imagen', icon: '🖼', isContainer: false, tab: 'html', category: 'media', defaultProps: { src: 'https://placehold.co/600x300/e2e8f0/64748b?text=Imagen', alt: 'Imagen', className: 'rounded-lg max-w-full' } },
  { type: 'video', label: 'Vídeo', icon: '▶', isContainer: false, tab: 'html', category: 'media', defaultProps: { src: '', className: 'rounded-lg w-full' } },
  { type: 'audio', label: 'Audio', icon: '♪', isContainer: false, tab: 'html', category: 'media', defaultProps: { src: '', className: 'w-full' } },
  { type: 'iframe', label: 'iFrame', icon: '⧉', isContainer: false, tab: 'html', category: 'media', defaultProps: { src: 'about:blank', className: 'w-full h-48 rounded-lg border' } },
  ...
  // ── Navegación ──
  { type: 'navbar', label: 'Navbar', icon: '☰', isContainer: true, tab: 'ui', category: 'navegacion', defaultProps: { brand: 'Marca', items: 'Inicio,Productos,Contacto', className: 'flex items-center justify-between bg-white border-b px-6 py-3' } },
  { type: 'sidebar', label: 'Sidebar', icon: '◧', isContainer: true, tab: 'ui', category: 'navegacion', defaultProps: { items: 'Dashboard,Usuarios,Configuración,Reportes', className: 'w-56 bg-slate-900 text-white min-h-[200px] p-2' } },
  ...
  { type: 'tabs', label: 'Tabs', icon: '⊞', isContainer: false, tab: 'ui', category: 'navegacion', defaultProps: { items: 'General,Ajustes,Avanzado', className: 'flex border-b border-slate-200' } },
  ...
  { type: 'menu', label: 'Menú', icon: '≡', isContainer: false, tab: 'ui', category: 'navegacion', defaultProps: { items: 'Perfil,Configuración,—,Cerrar sesión', className: 'bg-white border rounded-lg shadow-lg py-1 w-48' } },

  // ── Visualización de datos ──
  { type: 'card', label: 'Card', icon: '🃏', isContainer: true, tab: 'ui', category: 'datos', defaultProps: { className: 'bg-white rounded-xl shadow-sm border p-5' } },
  ...
  { type: 'tag', label: 'Tag', icon: '🏷', isContainer: false, tab: 'ui', category: 'datos', defaultProps: { text: 'React', className: 'inline-flex items-center gap-1 bg-slate-100 text-slate-700 text-xs font-medium px-2.5 py-1 rounded-md' } },
  ...
  // ── Overlay ──
  { type: 'modal', label: 'Modal', icon: '◫', isContainer: true, tab: 'ui', category: 'overlay', defaultProps: { title: 'Título del modal', className: 'bg-white rounded-xl shadow-2xl p-6 max-w-md border' } },
  { type: 'drawer', label: 'Drawer', icon: '◨', isContainer: true, tab: 'ui', category: 'overlay', defaultProps: { title: 'Panel lateral', className: 'bg-white shadow-xl p-6 w-80 min-h-[200px] border-l' } },
  ...
  { type: 'collapse', label: 'Collapse', icon: '▾', isContainer: true, tab: 'ui', category: 'layout-ui', defaultProps: { title: 'Más información', className: 'border rounded-lg' } },
